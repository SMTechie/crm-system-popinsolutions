...
const configuredWorkspaceSlug = process.env.NEXT_PUBLIC_WORKSPACE_SLUG?.trim() || "demo-tenant";
...
export default function LoginPage() {
  ...
  const [workspaceSlug, setWorkspaceSlug] = useState(configuredWorkspaceSlug);
