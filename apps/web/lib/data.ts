...
export const moduleCards: ModuleCard[] = [
  ...
  {
    title: "Form Builder",
    subtitle: "Templates, fields, responses",
    href: "/forms/builder",
    icon: FolderKanban,
    tint: "bg-amber-50 text-amber-600",
    submodules: [
      { title: "Builder", subtitle: "Design live forms", href: "/forms/builder", icon: FolderKanban },
      { title: "Templates", subtitle: "Reusable form sets", href: "/forms/templates", icon: FormInput },
      { title: "Responses", subtitle: "Submission records", href: "/forms/responses", icon: Receipt },
      { title: "Public Links", subtitle: "Embedded form access", href: "/forms/public-links", icon: Radar },
    ],
  },
  {
    title: "Automation",
    subtitle: "Workflows and triggers",
    href: "/automation",
    icon: Workflow,
    tint: "bg-violet-50 text-violet-600",
    submodules: [
      { title: "Workflows", subtitle: "Flow definitions", href: "/automation/workflows", icon: Workflow },
      { title: "Triggers", subtitle: "Event sources", href: "/automation/triggers", icon: Radar },
      { title: "Actions", subtitle: "Emails, tasks, updates", href: "/automation/actions", icon: FormInput },
      { title: "Logs", subtitle: "Run history and status", href: "/automation/logs", icon: Receipt },
    ],
  },
  {
    title: "Settings",
