        ...
        <div className="w-full max-w-[560px] rounded-[28px] border border-white/70 bg-white/95 p-5 shadow-[0_20px_60px_rgba(84,113,181,0.14)] md:p-6">
          ...
          <form onSubmit={handleEmailLogin} className="mx-auto mt-6 max-w-[500px] space-y-3 md:mt-7">
            ...
            <div className="flex flex-col items-center gap-3 pt-1">
              ...
              <div className="flex w-full items-center gap-3 py-1 text-[11px] font-medium uppercase tracking-[0.14em] text-slate-400"><span className="h-px flex-1 bg-line" />or continue with<span className="h-px flex-1 bg-line" /></div>
              <div className="grid w-full gap-3 sm:grid-cols-2">
                <button type="button" onClick={() => void startOAuth("google")} className="flex items-center justify-center gap-2.5 rounded-2xl border border-line bg-white px-4 py-3 text-[12px] font-semibold text-slate-700 transition hover:border-slate-300 hover:bg-soft">
                  <svg aria-hidden="true" viewBox="0 0 24 24" className="h-4 w-4"><path fill="#4285F4" d="M21.35 12.27c0-.71-.06-1.4-.18-2.05H12v3.88h5.24a4.48 4.48 0 0 1-1.94 2.94v2.44h3.14c1.84-1.69 2.91-4.18 2.91-7.21Z"/><path fill="#34A853" d="M12 21.75c2.63 0 4.84-.87 6.45-2.36l-3.14-2.44c-.87.58-1.98.92-3.31.92-2.54 0-4.69-1.72-5.46-4.03H3.2v2.52A9.74 9.74 0 0 0 12 21.75Z"/><path fill="#FBBC05" d="M6.54 13.84A5.85 5.85 0 0 1 6.24 12c0-.64.11-1.26.3-1.84V7.64H3.2A9.76 9.76 0 0 0 2.25 12c0 1.57.38 3.05.95 4.36l3.34-2.52Z"/><path fill="#EA4335" d="M12 6.13c1.43 0 2.71.49 3.72 1.45l2.79-2.79C16.84 3.22 14.63 2.25 12 2.25a9.74 9.74 0 0 0-8.8 5.39l3.34 2.52C7.31 7.85 9.46 6.13 12 6.13Z"/></svg>
                  Continue with Google
                </button>
                <button type="button" onClick={() => void startOAuth("microsoft")} className="flex items-center justify-center gap-2.5 rounded-2xl border border-line bg-white px-4 py-3 text-[12px] font-semibold text-slate-700 transition hover:border-slate-300 hover:bg-soft">
                  <svg aria-hidden="true" viewBox="0 0 24 24" className="h-4 w-4"><path fill="#F35325" d="M2.5 2.5h9.1v9.1H2.5z"/><path fill="#81BC06" d="M12.4 2.5h9.1v9.1h-9.1z"/><path fill="#05A6F0" d="M2.5 12.4h9.1v9.1H2.5z"/><path fill="#FFBA08" d="M12.4 12.4h9.1v9.1h-9.1z"/></svg>
